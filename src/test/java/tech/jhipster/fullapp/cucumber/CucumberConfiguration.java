package tech.jhipster.fullapp.cucumber;
...
import tech.jhipster.fullapp.FullappApp;
import tech.jhipster.fullapp.cucumber.CucumberConfiguration.CucumberRestTemplateConfiguration;
...
@SpringBootTest(classes = { FullappApp.class, CucumberRestTemplateConfiguration.class }, webEnvironment = WebEnvironment.RANDOM_PORT)
