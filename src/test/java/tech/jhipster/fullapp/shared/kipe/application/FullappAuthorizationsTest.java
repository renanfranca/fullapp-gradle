...
import static tech.jhipster.fullapp.shared.kipe.domain.RolesAccessesFixture.*;
...
import tech.jhipster.fullapp.shared.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class FullappAuthorizationsTest {

  private static final FullappAuthorizations authorizations = new FullappAuthorizations(List.of(rolesAccesses()));
